		...
		<div class="container">
			<nav class="navbar navbar-expand-lg navbar-light">
                ...
                <li class="nav-item">
                    ...
                    <p style="color:blue;">| Yüklediğim Şarkılar |</p>
                </li>
	...
	<div class="form-row">
		...
		<div class="col">
			<div class="md-form mb-4">
				...
				<label data-error="wrong" data-success="right" for="form2">Dosya Formatı</label>
			</div>
		</div>
		
		<div class="col">
			<div class="text-center">
				<button type="submit" name="upload" class="btn btn-default btn-rounded mb-4">Yükle <i class="fa fa-upload"></i></button>
			</div>
		</div>
	</div>	
</form>
