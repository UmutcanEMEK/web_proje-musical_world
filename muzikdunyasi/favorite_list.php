...
<head>
	<title>Musical World | Arabesk</title>
...
<body>
	...
	<header>
		<div class="container">
			<nav class="navbar navbar-expand-lg navbar-light">
                ...
                <li class="nav-item">
                    ...
                    <p style="color:blue;">| Favori Şarkılar |</p>
                </li>
      ...
      aria-haspopup="true" aria-expanded="false">Şarkı</button>
	...
	<div class="contact-top text-center" id="more_info">
		...
		<h3 class="stat-title text-white">Daha fazla detay için</h3>
			...
			<p class="text-white w-75 mx-auto">Musical World Şarkıcılar için kurulmuş bir platformdur.		</p>
			</p>
		</div>
	</div>
	<!-- //contact top -->
