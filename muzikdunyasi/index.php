			...
			<nav class="navbar navbar-expand-lg navbar-light">
				...
				<div class="collapse navbar-collapse" id="navbarSupportedContent">
					<ul class="navbar-nav text-center ml-auto">
						...
						<li class="nav-item">
							<a class="nav-link scroll" href="" data-target="#modalLRForm" data-toggle="modal">Giriş/Kayıt</a>
						</li>
						<li class="nav-item">
							<a class="nav-link scroll" href="#contact">iletişim</a>
						</li>
					</ul>
				</div>
			</nav>
		...
		<div class="container">
			<div class="banner-text">
				<div class="slider-info text-right">
					...
					<a class="btn btn-agile  mt-4 scroll" href="#about" role="button">daha fazlası için</a>
				</div>
			</div>
		</div>
	</div>
			...
			<div class="col-lg-6 abbot-right px-md-5  py-lg-0 py-3">
				<div class="card">
					<div class="card-body px-lg-5">
						...
						<a href="#more_info" class="btn btn-agile abt_card_btn scroll">Daha fazlası için</a>
					</div>
				</div>
			</div>
		</div>
